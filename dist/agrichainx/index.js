...
function AgrichainxHandler(ctx) {
    return {
        ...
        evmWithdrawal: function () {
            var instance = new withdrawal_1.default(ctx);
            return {
...
exports.default = AgrichainxHandler;
