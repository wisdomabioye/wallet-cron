...
function providerWithSigner(blockchain) {
    var distributionAddressKey = blockchain.distributionAddressKey, rpcUrl = blockchain.rpcUrl, chainId = blockchain.chainId, name = blockchain.name;
...
function providerWithoutSigner(blockchain) {
    var rpcUrl = blockchain.rpcUrl, chainId = blockchain.chainId, name = blockchain.name;
...
function contractWithSigner(currency, blockchain) {
    return __awaiter(this, void 0, void 0, function () {
        var contractAddress, distributionAddressKey, rpcUrl, chainId, name, provider, wallet;
        return __generator(this, function (_a) {
            contractAddress = currency.contractAddress;
            distributionAddressKey = blockchain.distributionAddressKey, rpcUrl = blockchain.rpcUrl, chainId = blockchain.chainId, name = blockchain.name;
            provider = new ethers_1.ethers.JsonRpcProvider(rpcUrl, {
                name: name,
                chainId: Number(chainId),
            });
            wallet = new ethers_1.ethers.Wallet(distributionAddressKey, provider);
            return [2 /*return*/, new ethers_1.ethers.Contract(contractAddress, erc20_1.default, wallet)];
        });
    });
}
